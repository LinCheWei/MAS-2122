...
MODEL = 'connection3legs_open_low_res.obj'
...
print_organizer.create_printpoints(False)
...
set_linear_velocity_constant(print_organizer, v= 100) # velocity
set_blend_radius(print_organizer, d_fillet=10) # blend radius
...
# ==========================================================================
viewer = app.App(width=1280, height=720)
slicer.visualize_on_viewer(viewer, False, True)
viewer.show()
